// Package parkingcontrol turns parking planner setpoints and measured vehicle
...
var ErrInvalidConfig = errors.New("invalid parking feedback controller configuration")
var ErrInvalidInput = errors.New("invalid parking feedback controller input")
