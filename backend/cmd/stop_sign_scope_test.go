...
func TestFilterStopSignTripDirsAcceptsOnlyCurrentTemporalContract(t *testing.T) {
	...
	legacyUnrelated := filepath.Join(root, "run-old", "old-scene_default", "trip-001")

	got := filterStopSignTripDirs([]string{legacyDriving, stopSignOld, legacyUnrelated, stopSignCurrent})
